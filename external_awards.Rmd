...
tibble::tribble(
  ...
  "PI with co-PIs Joel Adams, David Benson, Serita Nelesen, Randall DeJong",
  ...
  "co-PI with David Koetje (PI), Amy Wilstermann, Herbert Fynewever, and Randall Van Dragt",
  ...
  "co-PI with David Benson (PI), David DeHeer, Matthew Walhout, and Chad Tatko",
  ...
  "co-PI with Daniel Kaplan (PI), Nicholas Horton, and Eric Marland",
  ...
  "PI with co-PIs Joel Adams, David DeHeer, David Koetje, and Kieth Vander Linden",
